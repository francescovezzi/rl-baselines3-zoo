...
# TASK_ENV = ['JUMPING_IN_PLACE', 'JUMPING_FORWARD_HEIGHT']#, 'JUMPING_FORWARD']
# TASK_ENV = ['JUMPING_IN_PLACE_PPO', 'JUMPING_FORWARD_PPO']
# TASK_ENV = ['JUMPING_IN_PLACE_PPO_HP']
TASK_ENV = ['CONTINUOUS_JUMPING_FORWARD_PPO']

# TASK_ENV = ['JUMPING_IN_PLACE_PPO_HP']# , 'JUMPING_FORWARD_HP']

OBSERVATION_SPACE_MODE = ['PPO_BASIC']
ACTION_SPACE_MODE = ['SYMMETRIC']
# ENV_RANDOMIZER_MODE = ['TEST_RANDOMIZER_CURRICULUM', 'TEST_RANDOMIZER']
...
FOLDER = 'logs/logs_continuous_jf'
MODEL = 'best_model.zip'
AGENT_PATH = [os.path.join('logs_ppo', 'to_retrain_single_jf')]
...
if __name__ == '__main__':
    ...
    hyperparams['policy_kwargs'] = ARCH
